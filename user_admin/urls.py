...
from user_admin.views import CourseView, TokenGroupView, ResponseInvitationToBecameUserAdminView, \
...
urlpatterns = [
    ...
    path('token-group/', TokenGroupView.as_view(), name='token-group'),
